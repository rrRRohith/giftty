...
$(document).ready(function() {
    setTimeout(function() {
        ...
        Morris.Bar({
            ...
            barColors: ["#4680ff", "#7759de", "#11c15b"]
        });
        ...
        Morris.Bar({
            ...
            ykeys: ['a', 'b', 'c'],
            labels: ['Bar 1', 'Bar 2', 'Bar 3'],
            barColors: ["#ffa21d", "#ff5252", "#4680ff"]
        });
        ...
        Morris.Area({
            ...
            lineColors: ['#11c15b', '#7759de', '#4680ff'],
            xkey: 'period',
        ...
        var graph_real = Morris.Line({
            ...
            ymin: -1.0,
            ymax: 1.0,
            lineColors: ['#ffa21d', '#ff5252', '#4680ff'],
            pointSize: 4,
            responsive: true,
            pointFillColors: ['#fff', '#fff', '#fff'],
            pointStrokeColors: ['#ffa21d', '#ff5252', '#4680ff'],
            lineWidth: 2,
            hideHover: true
        });
