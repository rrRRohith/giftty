...
(function() {
    ...
    function Dattaopnmdl(src, formattedSrc, parentEl) {
        document.querySelector('.datta-example-modal-content').innerHTML = '<pre><code class="hljs html xml">' + formattedSrc + '</code></pre>';
        // parentEl.children('.datta-example-modal-content').innerHTML = '<pre><code class="hljs html xml">' + formattedSrc + '</code></pre>';
    ...
    Array.prototype.slice.call(document.querySelectorAll('.datta-example')).forEach(function(parentEl) {
        ...
        codes.className = 'datta-example-modal-content';
        ...
        btn_md_collapse.addEventListener('click', function(e) {
            if (btn_md_collapse.parentElement.childNodes[0].style.display == "none")
                ...
                btn_md_collapse.parentElement.childNodes[0].style.display = "none";
        });
        // Dattaopnmdl(src, formattedSrc,parentEl);
    });
})();
