            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                            <h1 class="d-inline-block font-weight-normal mb-0">@if(isset($product))  Edit Product @else Create New Product @endif  </h1>
                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                            <a href="{{url('admin/products')}}" class="btn d-block ml-auto btn-primary" role="button"><i class="feather icon-plus mr-2"></i>Back to Products</a>
                ...
                <div class="card">
                    <div class="card-body">
               <!--          <h5 class="mb-4"> @if(isset($product)) Edit Product @else Add Product @endif </h5> -->
                        <form
                            action="@if(isset($product)){{admin('products/'.$product->id)}}@else{{admin('products')}}@endif"
                            ...
                            <div id="tabs-wrapper">
                                ...
                                <ul id="tabs-titles">
                                    <li><a href="#product-info" class="active">Product Details</a></li>
                                    <li><a href="#product-variants" class="">Variants</a></li>
                                    <li><a href="#product-categories" class="">Categories & Filters</a></li>
                                    <li><a href="#product-seo" class="">SEO</a></li>
                                </ul>
                                  
                                    <div id="tabs">
                                        <div class="tab-item active" id="product-info">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 form-group mb-4">
                                                         ...
                                                         <div class="col-sm-4 form-group mb-4">
                                                            <label class="h6 f-12 ">Store*</label>
                                                            <select name="store_id" class="form-control">
                                                                <option>Select a Store</option>
                                                                @foreach($stores as $store)
                                                                    <option value="{{$store->id}}" <?php 
                                                                    if(old('store_id',isset($product) ? $product->store_id:'')==$store->id)
                                                                        echo 'selected="selected"';
                                                                     ?> >{!!$store->name!!}</option>
                                                                @endforeach
                                                            </select>
                                                            <span class="form-error">{{$errors->first('store_id')}}</span>
                                                        </div> 
                                                    ...
                                                    <div class="row">       
                                                        <div class="col-sm-12 form-group">
                                                            ...
                                                            <textarea name="description" class="form-control" rows="10" placeholder="Product Description">{!! old('description',isset($product) ? $product->description:'') !!}</textarea>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 form-group mb-4">
                                                            <label class="h6 f-12">Shipping Method</label>
                                                            <select name="shipping_id" class="form-control" >
                                                                @foreach($shippings as $shipping)
                                                                    <option value="{{$shipping->id}}" @if(old('shipping_id',isset($product) ? $product->shipping_id:'') == $shipping->id) selected="selected" @endif 
                                                                    >{{$shipping->name}} - ({{$shipping->days < 1 ? 'Same day':($shipping->days > 1 ? $shipping->days.' days':'Next day')}} @if($shipping->delivery_date) Or Custom day @endif Delivery) @if($shipping->local_delivery) By Vendor in Selected Cities @endif </option>
                                                                @endforeach
                                                            </select>
                                                            <span class="form-error">{{$errors->first('shipping_id')}}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5 form-group mb-4">
                                                            <div class="form-check">
                                                              ...
                                                              <input class="form-check-input" class="form-control" type="checkbox" name="published" value="" id="flexCheckChecked" @if(old('published',isset($product) ? $product->published:0) == 1)
                                                                checked @endif>  
                                                               Product Visibilty
                                                              </label>
                                                            </div>
                                                    ...
                                                    <div class="jumbotron text-center">
                                                        <div class="row">
                                                            <div class="col-lg-12" id="upload-preview">
                                                                <img id="uploaded-image" style="width:200px;height:200px;"
                                                    ...
                                                    <div class="row form-action" id="form-action">
                                                        ...
                                                        <div class="col" >
                                                            <div class="form-group">
                                                                <button class="btn btn-primary btn-lg btn-block next-button" type="button">
                                                                    Next
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group mb-4">
                                                                    <select name="variant_stock[]"  class="form-control" class="form-control" >
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group mb-4">
                                                                    <textarea rows="2" 
                                                                        name="variant_description[]"  class="form-control" placeholder="Description">{{$variant->description}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group mb-4">
                                                                    <select name="variant_attribute_id[]]" class="form-control">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group mb-4">
                                                                    <input name="variant_attribute_value[]" class="form-control" type="text" value="{{$variant->attribute_value}}" />
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
                                                                <div class="form-group mb-4">
                                                        ...
                                                        <div class="jumbotron text-center" style="padding:5px;">
                                                            <div class="row">
                                                                <div class="col-lg-12" id="upload-preview">
                                                                    ...
                                                                    @endphp
                                                                    <img id="variant_preview1" style="width:200px;height:200px;"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-8">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group mb-4">
                                                                    <select name="variant_stock[]" class="form-control" >
                                                                        <option value="">Stock</option>
                                                                         <option value="-1">Not requied</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    <textarea rows="2" 
                                                                        name="variant_description[]" class="form-control" placeholder="Variant description">{{old('variant_description',isset($product_variants) ? $product_variants->description:'')}}</textarea>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group mb-4">
                                                                    <input name="variant_attribute_value[]" class="form-control" type="text" value="" />
                                        ...
                                        <div class="tab-item" id="product-categories">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 form-group mb-4">
                                                    ...
                                                    <div>
                                                        <select name="shopping_categories[]" class="form-control" id="shopping_categories" multiple>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 form-group mb-4">
                                                    ...
                                                    <select name="occasions[]" class="form-control" id="occasions" multiple>
                                                ...
                                                <div class="col-sm-6 form-group mb-4">
                                                    ...
                                                    <select name="relates[]" id="relates" class="form-control" multiple>
                                            ...
                                            <div class="row form-action">
                                                <div class="col" >
                                                    <div class="form-group">
                                                        <button class="btn btn-primary btn-lg next-button  btn-block" type="button">
                                                            Next
                                                        </button>
                                                    </div>
                                                </div>
...
$(function() {
    ...
    $("#tabs-titles li a").click(function(e) {
        e.preventDefault();
    ...
    $(".next-button").click(function(e){
        e.preventDefault();
        console.log($("#tabs-titles").find('.active').first().parent().next().find('a').first().html())
        $("#tabs-titles").find('.active').first().parent().next().find('a').first().trigger('click');
