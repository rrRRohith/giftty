            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Navigations</h1>
                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                        <a href="{{url('admin/navigations/create')}}" class="btn d-block ml-auto btn-primary"
                            role="button"><i class="feather icon-plus mr-2"></i>New Navigation</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {!! session('message') !!}
                                    @endif
                                    <form action="{{admin('navigations/drop')}}" method="post">
                                        @csrf
                                        <table id="usertable" class="table table-center mb-0 ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="form-group d-inline">
                                                            <div
                                                                ...
                                                                <input type="checkbox" name="checked[ ]"
                                                                    value="{{$navigation->id}}"
                                                                    id="checkbox-s-{{$navigation->id}}"
                                                                    class="vendors-for-delete">
                                                                <label for="checkbox-s-{{$navigation->id}}" class="cr"
                                                    ...
                                                    <td>{{$navigation->display_order}}</td>
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch custom-control-inline"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                id="list_input_featured{{$navigation->id}}"
                                                                {{$navigation->status ? 'checked':''}}
                                                                onchange="changeStatus('{{$navigation->id}}');">
                                                            <label class="custom-control-label"
                                                                id="list_label_featured{{$navigation->id}}"
                                                                for="list_input_featured{{$navigation->id}}"></label>
                                                        </div>
                                                    </td>
                                                    <td>{{$navigation->created_at->diffForHumans()}}</td>
                                                    <td class="text-right">
                                                        <a href="{{ route('navigations.edit', $navigation->id)}}"> <i
                                                                class="far fa-edit"></i></a> &nbsp;
                                                        <a href="{{ url('admin/navigations/'.$navigation->id.'/delete')}}"
                                                            onclick="javascript:return confirm('Do you want to delete the Navigation');">
...
function changeStatus(id) {
    if (id) {
        $.ajax({
            url: "/admin/navigations/" + id + "/status",
            type: 'get',
            data: {},
