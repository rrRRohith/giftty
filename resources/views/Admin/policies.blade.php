            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Policies</h1>

                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center 
                                justify-content-end mb-4 text-right">
                        <a href="{{url('admin/policies/create')}}" class="btn d-block ml-auto btn-primary"
                            role="button">
                            <i class="feather icon-plus mr-2"></i>New policy</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    @if(count($policies))
                                    <form action="{{admin('policies/drop')}}" method="post">
                                        @csrf
                                                        ...
                                                        <div class="form-group d-inline">
                                                            <div
                                                                ...
                                                                <input type="checkbox" name="checked[ ]"
                                                                    value="{{$policy->id}}"
                                                                    id="checkbox-s-{{$policy->id}}"
                                                                    class="vendors-for-delete">
                                                                <label for="checkbox-s-{{$policy->id}}" class="cr"
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch custom-control-inline"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                id="list_input_featured{{$policy->id}}"
                                                                {{$policy->status ? 'checked':''}}
                                                                onchange="changeStatus('{{$policy->id}}');">
                                                            <label class="custom-control-label"
                                                                id="list_label_featured{{$policy->id}}"
                                                                for="list_input_featured{{$policy->id}}"></label>
                                                        </div>
                                                    </td>
                                                    <td>{{$policy->created_at->diffForHumans()}}</td>
                                                    <td class="text-right">
                                                        <a href="{{ route('policies.edit', $policy->id)}}"> <i
                                                                class="far fa-edit"></i></a> &nbsp;
                                                        <a href="{{ url('admin/policies/'.$policy->id.'/delete')}}"
                                                            onclick="javascript:return confirm('Do you want to delete the Policy');">
                                     ...
                                     @else
                                    <div id="empty-message"><p>Sorry no policy exists. <a href="{{admin('policies/create')}}">Create the first policy</a></p></div>
                                    @endif
                                </div>
                            </div>
                        </div>
