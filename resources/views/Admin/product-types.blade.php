            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Product Types</h1>

                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center 
                                justify-content-end mb-4 text-right">
                        <a href="{{url('admin/product-types/create')}}" class="btn d-block ml-auto btn-primary"
                            role="button">
                            <i class="feather icon-plus mr-2"></i>New Product Type</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form action="{{admin('product-types/drop')}}" method="post">
                                        @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="form-group d-inline">
                                                            <div
                                                                ...
                                                                <input type="checkbox" name="checked[ ]"
                                                                    ...
                                                                    id="checkbox-s-{{$product_type->id}}"
                                                                    class="vendors-for-delete">
                                                                <label for="checkbox-s-{{$product_type->id}}" class="cr"
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch custom-control-inline"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                id="list_input_featured{{$product_type->id}}"
                                                                {{$product_type->status ? 'checked':''}}
                                                                onchange="changeStatus('{{$product_type->id}}');">
                                                            <label class="custom-control-label"
                                                                id="list_label_featured{{$product_type->id}}"
                                                                for="list_input_featured{{$product_type->id}}"></label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a href="{{ url('admin/product-types/'.$product_type->id.'/delete')}}"
                                                            onclick="javascript:return confirm('Do you want to delete the product type');">
                                     ...
                                     @else
                                    <div id="empty-message"><p>Sorry no product types. <a href="{{admin('product-types/create')}}">Create the first product type</a></p></div>
                                    @endif
                                </div>
                            </div>
                        </div>
