            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Blog Categories</h1>

                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                        <a href="{{url('admin/topics/create')}}" class="btn d-block ml-auto btn-primary"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form action="{{admin('topics/drop')}}" method="post">
                                        @csrf
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="form-group d-inline">
                                                            <div
                                                                ...
                                                                <input type="checkbox" name="checked[ ]"
                                                                    value="{{$topic->id}}"
                                                                    id="checkbox-s-{{$topic->id}}"
                                                                    class="vendors-for-delete">
                                                                <label for="checkbox-s-{{$topic->id}}" class="cr"
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch   custom-control-inline"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                id="list_input_featured{{$topic->id}}"
                                                                {{$topic->published ? 'checked':''}}
                                                                onchange="changePublished('{{$topic->id}}');">
                                                            <label class="custom-control-label"
                                                                id="list_label_featured{{$topic->id}}"
                                                                for="list_input_featured{{$topic->id}}">
                                                            </label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a href="{{ url('admin/topics/'.$topic->id.'/delete')}}"
                                                            onclick="javascript:return confirm('Do you want to delete the Post');">
