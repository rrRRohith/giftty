            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Users</h1>

                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center justify-content-end mb-4 text-right">
                        <a href="{{url('admin/users/create')}}" class="btn d-block ml-auto btn-primary" role="button"><i
                                class="feather icon-plus mr-2"></i>New User</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <form action="{{admin('users/drop')}}" method="post">
                                        ...
                                        <table id="usertable" class="table table-center mb-0 ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="form-group d-inline">
                                                            <div
                                                                ...
                                                                <input type="checkbox" name="checked[ ]"
                                                                    value="{{$user->id}}" id="checkbox-s-{{$user->id}}"
                                                                    class="vendors-for-delete">
                                                                <label for="checkbox-s-{{$user->id}}" class="cr"
                                                    ...
                                                    <td>{{$user->id}}</td>
                                                    <td>
                                                        <img src="{!!$user->picture != '' ? asset('images/users/'.$user->id.'/'.$user->picture):asset('images/users/dummy-image.jpg')!!}"
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch custom-control-inline"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                id="list_input_featured{{$user->id}}"
                                                                {{$user->status ? 'checked':''}}
                                                                onchange="changeStatus('{{$user->id}}');">
                                                            <label class="custom-control-label"
                                                                id="list_label_featured{{$user->id}}"
                                                                for="list_input_featured{{$user->id}}"></label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a href="{{ url('admin/users/'.$user->id.'/delete')}}"
                                                            onclick="javascript:return confirm('Do you want to delete the user');">
                                      ...
                                      @else
                                    <div id="empty-message"><p>Sorry no Users. <a href="{{admin('users/create')}}">Create the first User</a></p></div>
                                    @endif
                                </div>
                            </div>
                        </div>
