            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6 d-flex align-items-center mb-4">
                        <h1 class="d-inline-block font-weight-normal mb-0">Banners</h1>

                    </div>
                    <div class="col-sm-6 d-block d-sm-flex align-items-center 
                                justify-content-end mb-4 text-right">
                        <a href="{{url('admin/banners/create')}}" class="btn d-block ml-auto btn-primary" role="button">
                            <i class="feather icon-plus mr-2"></i>New Banner</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    @if(count($banners))
                                    <form action="{{admin('banners/drop')}}" method="post">
                                        @csrf
                                        <table id="usertable" class="table table-center mb-0 ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <div class="form-group d-inline">
                                                            <div
                                                                ...
                                                                <input type="checkbox" name="checked[ ]"
                                                                    value="{{$banner->id}}"
                                                                    id="checkbox-s-{{$banner->id}}"
                                                                    class="vendors-for-delete">
                                                                <label for="checkbox-s-{{$banner->id}}" class="cr"
                                                    ...
                                                    <td>{{$banner->id}}</td>
                                                    <td>
                                                        <img src="{!!$banner->picture != '' ? asset('images/banners/'.$banner->id.'/'.$banner->picture):asset('images/banners/dummy-image.jpg')!!}"
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch custom-control-inline"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                id="list_input_featured{{$banner->id}}"
                                                                {{$banner->status ? 'checked':''}}
                                                                onchange="changeStatus('{{$banner->id}}');">
                                                            <label class="custom-control-label"
                                                                id="list_label_featured{{$banner->id}}"
                                                                for="list_input_featured{{$banner->id}}"></label>
                                                        </div>
                                                    </td>
                                                    <td>{{$banner->created_at->diffForHumans()}}</td>
                                                    <td class="text-right">
                                                        <a href="{{ route('banners.edit', $banner->id)}}"> <i
                                                                class="far fa-edit"></i></a> &nbsp;
                                                        <a href="{{ url('admin/banners/'.$banner->id.'/delete')}}"
                                                            onclick="javascript:return confirm('Do you want to delete the Banner');">
                                     ...
                                     @else
                                         <div id="empty-message"><p>Sorry no banners. <a href="{{admin('banners/create')}}">Create the first Banner</a></p></div>
                                    @endif
                                </div>
                            </div>
                        </div>
