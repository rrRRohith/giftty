                                                ...
                                                <form method="get" action="">
                                                    <div class="product-sort">
                                                        ...
                                                        <select class="nice-select" name="sortby"  onchange="this.form.submit()">
                                                             <!--<option value="Ascending" @if(isset(Request()->sortby) && (Request()->sortby=='Ascending')) selected @endif>Name (A - Z)</option>-->
                                                                        ...
                                                                        <div class="product-caption">
                                                                            <div class="product-meta d-flex justify-content-between align-items-center">
                                                                               <!--  <div class="product-manufacturer">
                                                                                    <a href="{{url('gift/'.$product->slug)}}">{{$product->name}}</a>
                                                                                </div> -->
                                                                    ...
                                                                    <div class="product-thumb">
                                                                        <div class="product-inner media align-items-center">
                                                                            <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                                ...
                                                                                <img src="{!!$product->picture != '' ? asset('images/products/'.$product->id.'/'.$product->picture):asset('images/products/dummy-image.jpg')!!}"  style="width:300px;height:300px;"  title="Compete Track Tote" alt="Compete Track Tote">
                                                                                </a>
                                                                   <!--              <div class="action-links">
                                                                                    <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                                    <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                            ...
                                                                            <div class="product-caption media-body">
                                                                                <div class="product-manufacturer">
                                                                                    <a href="{{url('gift/'.$product->slug)}}">{{$product->type->name}}</a>
                                                                                </div>
                                            ...
                                            <div class="pagination-area">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-12 order-1 col-sm-12 col-md-6 order-md-2 col-lg-6">
                                                               ...
                                                               {{$products->links()}}     
                                                    <!-- <ul class="pagination">
                                                            <li class="page-item"><a href="{{$products->previousPageUrl()}}" class="page-link"><i class="fa fa-angle-left"></i> <span>Previous</span></a></li>
                                                               
                                                           
                                                            
                                                            <li class="page-item"><a href="{{$products->nextPageUrl()}}" class="page-link"><span>Next</span> <i class="fa fa-angle-right"></i></a></li>
                                                        </ul> -->
                                                    </div>
