                                                ...
                                                <form action="{{url('/shop/register')}}" method="post">
                                                   ...
                                                   <!--  <div class="login-info mb-half">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                                            <input type="password" class="form-control" id="c-password" name="confirm_password" required="">
                                                            <!-- <button class="pass-show-btn" type="button">Show</button> -->
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                                            <input type="text" class="form-control" id="f-name" name="firstname" required="" value="{{old('firstname')}}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                                            <input type="text" class="form-control" id="l-name" name="lastname" required="" value="{{old('lastname')}}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                                            <input type="text" class="form-control" id="phone_no" name="phoneno" required="" value="{{old('phoneno')}}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                                            <input type="text" class="form-control" id="postal_code" name="postalcode" required="" value="{{old('postalcode')}}">
