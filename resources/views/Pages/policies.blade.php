                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="faqs-intro mb-half">
                                <div class="section-title">
                                    <h2>Welcome To Gifty Policies!</h2>
                                </div>
                                ...
                                <div class="faqs-accordion" id="faqs_accordion">
                                    ...
                                    <div class="card">
                                        <div class="card-header" id="heading{{$faq->id}}">
                                            <h5 class="mb-0">
                                                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse{{$faq->id}}" aria-expanded="false" aria-controls="collapse{{$faq->id}}">{{$faq->title}}</button>
                                            </h5>
                                        </div>
